...
export function Subscribe({ headline, content, placeholder, buttonText }: Readonly<SubscribeProps>) {
  ...
  return (
    <section className="newsletter container">
      ...
      <form className="newsletter__form" action={formAction}>
        ...
        />
        <button type="submit" className="newsletter__subscribe btn btn--turquoise btn--medium">
          {buttonText}
        </button>
      </form>
    </section>
